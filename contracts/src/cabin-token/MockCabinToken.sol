...
contract MockCabinToken is Ownable, ICabinToken {
    ...
    function transferFrom(address from, address to, uint256 value) external override returns (bool) {
        require(allowance[from][msg.sender] >= value, "CabinToken: transfer amount exceeds spender allowance");
        ...
        override
    {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner_, "CabinToken: INVALID_SIGNATURE");
    ...
    function _transfer(address from, address to, uint256 value) private {
        require(balanceOf[from] >= value, "CabinToken: transfer amount exceeds balance");
